...
studydir = '/neurospin/grip/protocols/MRI/Resting_state_Victor_2014/atlases/atlas_fonctionel_control_AVCnn/TEST_ATLAS' + '_' + 'thresh' + str(threshold) + '_' + 'dist' + str(distance)        
...
function_build_atlas.create_3D_labels_file(studydir,roisDirName,name3Dlabelfile,savedir_atlas=atlas_files)

#Crée un fichier 4D a partir des ROIs issue de Labels_split au format nii.
function_build_atlas.concatenate_Nifti(studydir,roisDirName,name_file=atlas_4D_name,savedir_atlas=atlas_files)

#Enregistre les informations basiques concernant l'atlas généré dans le dossier studydir dans un .csv
function_build_atlas.basics_info_atlas(studydir,atlas_filedir=atlas_files,atlas_name=atlas_4D_name,threshold_carte=threshold
